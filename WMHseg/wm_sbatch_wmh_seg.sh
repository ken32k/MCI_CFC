...
# @FilePath: /csvd-sfc/sbatch_wmh_seg.sh
    ...
    (
        ...
        if [ ! -f $target_file ]; then
            sbatch --output="${sub_dir}/sbatch.txt" \
                ...
                --cpus-per-task=10 \
                --time=00:50:00 \
                /public/home/baishw/communication/csvd-sfc/WMHseg/mci_wmh_seg_lst.sh ${sub_id:4}

            # Synthseg
            # /public/home/baishw/communication/csvd-sfc/WMH_seg/svd_wmh_seg.sh $sub_dir 10
